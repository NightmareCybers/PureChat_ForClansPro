...
class PureChat extends PluginBase
{
    ...
    */
    ...
    public function onEnable()
    {
        ...
        $this->clansPro = $this->getServer()->getPluginManager()->getPlugin("ClansPro");
    ...
    public function getCustomChatFormat(Player $player, $message, $levelName = null)
    {
        ...
        if($this->clansPro !== null)
        {
            if($this->getConfig()->getNested("custom-no-clan-message") === null)
            {
                $this->getConfig()->setNested("custom-no-clan-message", "...");
